...
export default function StatementPage(){const q=readToolParams(useSearchParams());const [form]=useState<StatementInput>({department:(q.department as any)||'graphic',projectFormat:(q.projectFormat as any)||'poster',topic:q.topic||'الهوية في الزحمة',material:q.material||'كولاج ورق مطبوع',colors:q.colors||'درجات رمادي مع أحمر',mood:(q.mood as any)||'identity',message:q.message||'إن الهوية بتتكوّن من تفاصيل يومية صغيرة',experienceLevel:(q.experienceLevel as any)||'beginner'});const output=useMemo(()=>generateStatement(form),[form]);
